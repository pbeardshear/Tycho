 ...
 *
 */
Instance.pipeMessage = function (connectionName, message, suppressBubble) {
	...
	else if (!suppressBubble) {
		this.fire('pipe', this, connectionName, message);
	}
	else {
		// The connection is supposed to be managed in this instance, but it doesn't exist
